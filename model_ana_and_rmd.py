...
data = pd.read_csv('C:/Users/tdk19/Downloads/sales_data_realtime.csv')
...
with open('./Realtime/results_with_predictions.json', 'w', encoding='utf-8') as json_file:
    json.dump(results_json, json_file, ensure_ascii=False, indent=4)

with open('./Realtime/another.json', 'w', encoding='utf-8') as json_file:
